...
ActiveRecord::Schema[7.2].define(version: 2026_03_24_211119) do
  ...
  create_table "badges", force: :cascade do |t|
    ...
    t.index ["post_id"], name: "index_badges_on_post_id"
    t.index ["user_id", "post_id", "badge_type"], name: "index_badges_on_user_post_type", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "hometown_visibility", default: false, null: false
    t.datetime "hometowns_committed_at"
